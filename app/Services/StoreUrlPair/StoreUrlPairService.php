...
class StoreUrlPairService
{
     ...
     * 存在すればそのUrlPairを返す
     *
     * @param  RedirectableUrl $longUrl
     * @return UrlPair
     */
    public function storeIfNotExist(RedirectableUrl $longUrl): UrlPair
    {
        $urlPair = $this->urlPairRepository->getByOriginalUrl($longUrl)->first();
